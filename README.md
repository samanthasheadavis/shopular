...
To practice the basics of AngularJS, I created a web application for a shop's inventory. Shopular is just a simple interface that displays items with a few functions to calculate tax and display a sale ticket if the item is on sale.

[See it on GitHub Pages](https://samanthasheadavis.github.io/shopular/)
#### Languages/Tools
* AngularJS
* JavaScript
* HTML5
